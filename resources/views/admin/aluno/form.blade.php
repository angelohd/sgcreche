    ...
    <div class="col-lg-12">
        <div class="tabs-container">
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li><a class="nav-link" data-toggle="tab" href="#tab-encarregado-1">Dados do 1º encarregado.</a>
                </li>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control"
                                        value="{{ $encarregado1->data_validade }}">
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ $encarregado2->tipo_doc }}">
                                    </div>
                                    <div class="form-group">
                                        <label>Numero de Identificação</label>
                                        <input type="text" class="form-control"
                                            value="{{ $encarregado2->numero_doc }}">
                                    </div>

                                    <div class="form-group">
                                        <label>Data de Validade</label>
                                        <input type="date" class="form-control"
                                            value="{{ $encarregado2->data_validade }}">
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label>Telefone 1</label>
                                        <input type="text" class="form-control"
                                            value="{{ $encarregado2->telefone1 }}">
                                    </div>

                                    <div class="form-group">
                                        <label>Telefone 2</label>
                                        <input type="text" class="form-control"
                                            value="{{ $encarregado2->telefone2 }}">
                                    </div>
                                    <div class="form-group">
                                        <label>E-Mail</label>
                                        <input type="email" class="form-control"
                                            value="{{ $encarregado2->email }}">
                                    </div>
                                    <div class="form-group">
                                        <label>Endereo</label>
